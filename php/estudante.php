...
<body>
    ...
    <main class="container_texto">
        ...
        <section class="cartao_cidadao">
            <h1>Cartão Estudante</h1>
        </section>
        
        <section class="texto">
            <p>
                Este cartão destina-se aos estudantes a partir dos sete anos de idade,
                 garantindo o direito à meia passagem nos sistemas de transporte urbano de 
                 João Pessoa.
            </p>

            <h2>Como adquirir o Nubus Estudantil?</h2>

            <p>
                Se você é estudante e deseja garantir o seu direito à meia passagem, basta
                 obter o seu Nubus Estudantil. É necessário comparecer à Sede do SINTUR
                  ou solicitar via WhatsApp, fornecendo os seguintes documentos:
            </p>
            ...
            <ul>
                ...
                <li>Recarga mínima de R$10,00</li>
            </ul>

            <h3>Lembre-se, de acordo com a Lei 2848/40 falsificação de documento é crime.</h3>
            ...
            <p>
                ...
                <br>
                O cartão não possui validade, mas para evitar o bloqueio da recarga, 
                ele deve ser atualizado anualmente para estudantes do ensino médio e 
                semestralmente para universitários, pela instituição de ensino à qual o 
                estudante pertence.
            </p>
            ...
            <p>
                A recarga pode ser efetuada online por meio do site ou aplicativo, ou
                presencialmente em uma dos nossos pontos de atendimento e redes
                parceiras por toda a cidade. Para informações sobre os locais e horários de
                funcionamento de todos os pontos, acesse o link "<a href="../php/pontoderecarga.php">Posto de
                    Vendas</a>" no site.
            </p>
        </section>
    </main>
