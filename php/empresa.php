...
<body>
    ...
    <section class="container_texto">
        ...
        <section class="texto">
            <p>
                Você sabia que a sua empresa pode adquirir o vale-transporte para os seus colaboradores de forma gratuita, descomplicada e rápida? O vale-transporte é
                vantajoso e seguro, além de ser um direito dos trabalhadores. Para as empresas adquirirem o vale-transporte para seus colaboradores é muito fácil: basta
                preencher as informãções abaixo e uma planilha com os dados dos funcionários (nome completo, RG, CPF e data de nascimento) que os cartões serão emitidos.
            </p>
            <br>
            <p>
                A recarga pode ser realizada online, por meio do site, com emissão de boleto bancário, ou então presencialmente na Sede do SINTUR. Lembrando que a 
                recarga do vale-transporte só pode ser feita pela própria empresa.
                <br>
                <br>
                Em caso de perda ou roubo do cartão, somente o responsável da empresa poderá realizar o bloqueio diretamente pelo site com login e senha.
                <br>
                <br>
                <a href="https://passelegal.com.br/v19/wp-content/uploads/2019/05/MODELO-DE-CADASTRO.xlsx">BAIXE A PLANILHA MODELO AQUI</a>
                <br>
                <br>
            </p>
            <form action="">
