...
<body>
    ...
    <section class="container_texto">
        ...
        <section class="titulo">
            <h1>O que eu preciso levar para fazer a 2ª via do cartão?</h1>
        </section>

        <section class="texto">
            <p>
                Caso seja o cartão Nubus Estudantil basta levar CPF, carteira de estudante e a taxa de R$ 20,80.
                Se for o cartão Nubus cidadão é só levar CPF e a taxa de R$ 20,80.
            </p>
        </section>
