...
<head>
    ...
    <link rel="stylesheet" href="../css/perdaeroubo.css">
...
<body>
    ...
    <section class="container_texto">
        ...
        <section class="texto">
            <p>
                Em caso de perda ou extravio do seu cartão NuBus, entre em contato conosco por meio do número 3221-9092 para o bloqueio. Há também a opção de
                solicitar o bloqueio pelo e-mail cadastro@nubusjp.com.br. Depois, basta ir à sede do SINTUR, fazer o pagamento da taxa de R$ 20,80 e retirar sua 2ª via do
                cartão NuBus.
            </p>
            <h2>Informações Gerais sobre Bloqueio dos Cartões (Cidadão, Estudante, Vale Transporte)</h2>
            <p>
                Os créditos remanescentes da via anterior serão creditados no novo cartão após 48 horas do efetivo bloqueio;
                <br>
                O Valor a ser creditado na nova via só poderá ser feito fisicamente com a presença do cartão na sede do SINTUR, na Rua Treze de Maio, 103 – Centro – João Pessoa;
            </p>
        </section>
