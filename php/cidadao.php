...
<body>
    ...
    <main class="container_texto">
        ...
        <section class="cartao_cidadao">
            <h1>Cartão Cidadão</h1>
        </section>
        
        <section class="texto">
            <p>
                Aos usuários de ônibus que não pertencem à categoria de estudantes ou
                vale-transporte,este é o seu cartão! Com o Cartão Cidadão, você ganha
                agilidade no embarque, pode programar suas recargas e desfruta da
                conveniência e segurança da bilhetagem eletrônica, recarregando somente
                quando necessário.
            </p>

            <h2>Como adquirir o cartão NuBus cidadão?</h2>

            <p>
                Com o Nubus, o usuário tem a vantagem de poder integrar sua passagem
                no ônibus. Para obter o seu cartão e garantir esses benefícios, basta dirigir
                se a qualquer ponto de atendimento ou solicitar via WhatsApp, fornecendo
