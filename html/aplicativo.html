...
<body>
    <header class="header">
        <div class="header-content">
            <a href="../php/pag_inicial.php"><img src="../media/nubus.png" width="142" height="45" class="logo"
                    alt="logo"> </a>
            <nav class="nav-links">
                <a href="https://download-android.appnubus.com.br/"><img src="../media/baixar_android.png" alt=""
                        class="img_android"></a>
                <a href="https://download-ios.appnubus.com.br/"><img src="../media/baixar_apple.png" alt=""
                        class="img_apple"></a>
            </nav>
        </div>
    </header>
    ...
    <section class="container-app">
        <section class="content-wrapper">
            <section class="texto-container">
                <h1><span>NuBus</span> é mais mobilidade para você!</h1>
                <p>Confira no app!</p>
            <div class="download-buttons">
                <a href="https://download-android.appnubus.com.br/" class="btn-download google-play"><img src="../media/baixar_android.png" alt=""></a>

                <a href="https://download-ios.appnubus.com.br/" class="btn-download app-store"><img src="../media/baixar_apple.png" alt=""></a>
            </div>
            </section>
            <section class="img-celular">
                <img src="../media/print-04.png" alt="" class="celular-photo">
            </section>
